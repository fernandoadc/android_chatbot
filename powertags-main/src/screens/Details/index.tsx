...
const CHAT_GPD_API_KEY = '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';
const GCP_SPEECH_TO_TEXT_KEY = 'AIzaSyAX8PXe_nTppTnYTXT7GQ7rY8OWsl59pkA';
...
export function Details() {
  ...
  function handleFetchTags() {
    setIsLoading(true);
    const prompt = `
        return doubts in Portuguese and in a layman way about ${description.trim()}.
    `;
    ...
    fetch("https://api.openai.com/v1/engines/text-davinci-003-playground/completions", {
      ...
      .catch(() => Alert.alert('Erro', 'Não foi possível encontrar a resposta.'))
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <TextArea
            placeholder="Em que eu posso ajudar?"
